...
int main(int argc, char **argv)
{
    ...
    // string ftrack = "result_mapsl/FrameTrack.txt";
    // ofstream f;
    // f.open(ftrack.c_str());
    // f << fixed;
    // Main loop
    ...
    SLAM.SaveKeyFrameTrajectoryTUM("result_mapsl/KeyFrameTrajectory.txt");  
    // SLAM.SaveTrajectoryMonoTUM("FrameTrajectory.txt"); //也保存所有普通帧轨迹

    // 保存点云到txt
    string ptsfile = "result_mapsl/office0_orb_mappts.txt";
