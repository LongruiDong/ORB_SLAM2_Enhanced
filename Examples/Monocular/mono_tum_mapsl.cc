...
int main(int argc, char **argv)
{
    if(argc != 5)
    {
        // ./mono_tum Vocabulary/ORBvoc.txt Examples/Monocular/TUMX.yaml dataset/TUM/rgbd_dataset_freiburg1_desk 0/1
        cerr << endl << "Usage: ./mono_tum path_to_vocabulary path_to_settings path_to_sequence vis(0|1)" << endl;
        return 1;
    }
